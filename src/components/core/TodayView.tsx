...
export function TodayView({ onCapture, onOpenTask, onOpenPlan }: { onCapture: () => void; onOpenTask: (task: WaylineTask) => void; onOpenPlan: () => void }) {
  ...
  const startTask = useWayline((state) => state.startTask);
